...
### 👤 Benutzer-Administration (Auszuführen als SYSTEM-User)
...
### 📂 Verzeichnis- und Job-Berechtigungen (Auszuführen als SYSTEM-User)
...
### 🔄 Identity-Spalten (Auto-Increment) nach TRUNCATE zurücksetzen
...
### 🕵️‍♂️ Package- & Job-Troubleshooting (Notfall-Befehle)
